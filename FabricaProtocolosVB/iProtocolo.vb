Public Interface iProtocolo
    ...
    Sub Evento_VentaAutorizada(Cara As Byte, Precio As String, ValorProgramado As String, TipoProgramacion As Byte, Placa As String, MangueraProgramada As Int32, EsVentaGerenciada As Boolean)
    ...
    Event AutorizacionRequerida(Cara As Byte, Producto As Long, idManguera As Long, Lectura As String)
