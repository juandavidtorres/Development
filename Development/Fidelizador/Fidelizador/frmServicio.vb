    ...
    Private Sub frmServicio_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            Catch Ex As POSstation.Fabrica.GasolutionsHaspException
                MessageBox.Show("LLAVE HASP NO ENCONTRADA" & vbNewLine & "Por favor conecte en el puerto USB la llave de licencia" & vbNewLine & "e intente abrir de nuevo el aplicativo", Application.ExecutablePath, MessageBoxButtons.OK, MessageBoxIcon.Error)
                Me.Close()
