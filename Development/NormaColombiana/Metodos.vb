...
Public Class Metodos
    <DllImport("Suic2fish.dll", CharSet:=CharSet.Unicode)> _
    Public Shared Sub Suic2Plain(ByRef Bycrypto As Byte, ByVal longitud As Integer, ByRef Byplain As Byte)

    End Sub
    '' Declare Sub Suic2Plain Lib "Suic2fish.dll" (Bycrypto As Byte, ByVal longitud As Integer, Byplain As Byte)
    ...
    Public Function Desencriptar2Fish(ByRef origen() As Byte) As String
        ...
        Metodos.Suic2Plain(origen(1), 128, Resultado(1))
