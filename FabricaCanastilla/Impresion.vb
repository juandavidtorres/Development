    ...
    Private Shared Function RecuperarCierreParcialTurno(ByVal codigoKiosco As String) As InformacionTurno
        ...
        Try
            ...
            If Not Datos Is Nothing Then
                ...
                Next
            Else
                Throw New System.Exception("Falla al recuperar El cierre parcial de turno en el kiosco con codigo " & codigoKiosco)
            End If
            Return InfoTurno
    ...
    Private Shared Function RecuperarCierreTurno(ByVal idTurno As Int32) As InformacionTurno
        ...
        Try
            ...
            If Not Datos Is Nothing Then
                ...
                Next
            Else
                Throw New System.Exception("Falla al recuperar El cierre de turno " & idTurno)
            End If
            Return InfoTurno
        Catch ex As System.Exception
