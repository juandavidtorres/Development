...
#Region "CONSTRUCTORS"
    ...
    ''' <remarks></remarks>
    Sub New(ByVal Hostname As String, ByVal Username As String, ByVal Password As String, ByVal TimeOut As Integer, ByVal TimeOutReadWrite As Integer)
        _hostname = Hostname
        _username = Username
        _password = Password
        _Timeout = TimeOut
        _TimeOutWriteRead = TimeOutReadWrite
    End Sub
#End Region
...
#Region "private supporting fns"
    ...
    Private Function GetRequest(ByVal URI As String) As FtpWebRequest
        ...
        result.ReadWriteTimeout = Me.TimeOutWriteRead
        Return result
    End Function
...
#Region "Properties"
    ...
    Public Property Username() As String
        Get
            Return IIf(_username = "", "anonymous", _username).ToString
        End Get
        Set(ByVal value As String)
            _username = value
        End Set
    ...
    ''' <summary>
    ''' TimeOutWriteRead  property
    ''' </summary>
    ''' <value></value>
    ''' <remarks>Can be left blank, in which case 'anonymous' is returned</remarks>
    Private _TimeOutWriteRead As Integer
    Public Property TimeOutWriteRead() As Integer
        Get
            Return _TimeoutWriteRead
        End Get
        Set(ByVal value As Integer)
            _TimeoutWriteRead = value
        End Set
    End Property
...
Public Class FTPdirectory
    ...
    Private Const slash As Char = CChar("/")
