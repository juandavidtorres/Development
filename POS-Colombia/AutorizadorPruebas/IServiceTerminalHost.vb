...
Public Interface IServiceTerminalHost
    ...
    <OperationContract()> _
    Function VerificarBonoSodexo(ByVal NroConfirmacion As String) As RespuestaVerificarBonoSodexo
    ...
    <OperationContract()> _
    Function RecuperarProductoCanastilla(Codigo As String) As DTOProducto
