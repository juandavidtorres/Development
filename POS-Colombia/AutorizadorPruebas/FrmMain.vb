...
#Region "Multihilo"
    ...
    Public Sub AutorizarVentaCredito(ByVal esLecturaChipObligatoria As Boolean, ByVal cara As Byte, ByVal idProducto As Int32, ByVal idManguera As Int16, ByVal Identificador As String, ByVal TipoIdentificador As TipoIdentificadorVehiculo, ByRef OPreset As Preset, Optional esAutorizado As Boolean = True)
        ...
        If OPreset.TipoPreset = Preset.Tipo.PorValor And OPreset.Valor > 0 Then
            If (CInt(OPreset.Valor) >= CInt(CreditosEstacion(cara.ToString()).ValorPredeterminado)) And CreditosEstacion(cara.ToString()).ValorPredeterminado > 0 Then
                OPreset.Valor = CreditosEstacion(cara.ToString()).ValorPredeterminado
            End If
        ElseIf OPreset.TipoPreset = Preset.Tipo.PorVolumen And OPreset.Valor > 0 Then
            If CInt(OPreset.Valor * PrecioProducto) > CInt(CreditosEstacion(cara.ToString()).ValorPredeterminado) And CInt(CreditosEstacion(cara.ToString()).ValorPredeterminado) > 0 Then
                OPreset.Valor = CreditosEstacion(cara.ToString()).ValorPredeterminado
                OPreset.TipoPreset = Preset.Tipo.PorValor
            Else
...
#Region "Eventos y Funciones de Venta "
    ...
    Private Sub oEventos_AutorizacionRequerida(cara As Byte, producto As Integer, idManguera As Integer, lectura As String)
        ...
        Catch Ex As GasolutionsHaspException
            ...
            oEventos_ExcepcionOcurrida("LLAVE HASP NO ENCONTRADA", True, False, "")
            ' LogFallas.ReportarError(New System. System.Exception("LLAVE HASP NO ENCONTRADA"), "AutorizacionRequerida", "-", "AutorizacionRequerida")
    ...
    Private Sub oEventos_VentaFinalizada(cara As Byte, valor As String, precio As String, lecturaFinal As String, cantidad As String, producto As Byte, manguera As Integer, presionLLenado As String, lecturaInicial As String)
        Try
            ...
            Else
                ...
                'Catch ex As System. System.Exception
...
#End Region
        ...
        Try
            ...
            If tipoValidacion = ETipoValidacion.BaseDatos And SolicitaLecturaChip Then
                If oHelper.ExisteVehiculo(DatosVehiculo.Placa) Then
                    ...
                    '    Throw New System. System.Exception("El chip no corresponde a una venta para GNV.")
                Else
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        'If CreditosEstacion.ContainsKey(1) Then
        '    CreditosEstacion.Remove(1)
        'End If

        'CreditosEstacion.Add(1, New CreditoFullstation() With {.ValorPredeterminado = "50000"})
        'Me.AutorizarVentaCredito(False, 1, 3, 7, "0B000016F2B64C01", TipoIdentificadorVehiculo.CHIP, BuscarPreset(1))
        Dim saldo As String = "60000"
        Dim mr As String = "500000"
        If saldo > mr Then
            MsgBox("Saldo es mayor")
        Else
            MsgBox("MR es mayor")
        End If
