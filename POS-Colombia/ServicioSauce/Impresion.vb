...
Public Class InformacionRecibo
    ...
    Private _SaldoTarjetaPrepago As String
    Public Property SaldoTarjetaPrepago() As String
        Get
            Return _SaldoTarjetaPrepago
        End Get
        Set(ByVal value As String)
            _SaldoTarjetaPrepago = value
        End Set
    End Property
