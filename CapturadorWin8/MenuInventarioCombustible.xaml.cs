...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuInventarioCombustible : Page
    {
        ...
        public MenuInventarioCombustible()
        {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnReciboCombustible":
                    try
                    {
                        Funciones.MsgBox("Se llamará a la pagina frmReciboCombustible para inciar el proceso de recibo de combustible - CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnRemarcacion":
                    try
                    {
                        Funciones.MsgBox("Se llamará a la pagina frmRemarcacionCombustible - CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
