...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuCanastillaVenta : Page
    {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnCreditoCanastilla":
                    try
                    {
                        
                        Funciones.MsgBox("Se solicitan los datos inicales de venta credito canastilla y luego se envia  a la pagina de ProductosCanastillaVentaNueva");
                        if (!this.Frame.Navigate(typeof(MenuCanastillaVentaCredito)))
                        {
                            throw new Exception("Failed to create MenuCanastillaVentaCredito page");
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnCanastillaVentaEfectivo":
                    try
                    {
                        Funciones.MsgBox("Se solicitan las credenciales del despachador y luego se envia  a la pagina de ProductosCanastillaVentaNueva");
                    }
                    catch (Exception ex)
                    {
