...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuGerenciamiento : Page
    {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnVentaCredito":
                    try
                    {                        
                        Funciones.MsgBox("Se llamará a la pagina frmCreditos- CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnVentaEfectivo":
                    try
                    {
                        Funciones.MsgBox("Se llamará a la pagina IfrmVentasEfectivo- CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
