...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuImpresion : Page
    {
            ...
            switch (oBoton.Name)
            {
                case "btnCopiaVenta":
                    ...
                    {                       
                        ...
                        if (!this.Frame.Navigate(typeof(MenuImpresionCopiaVenta)))
                        {
                            throw new Exception("Failed to create MenuImpresionCopiaVenta page");
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnCopiadeTurno":
                    try
                    {                       

                        if (!this.Frame.Navigate(typeof(MenuImpresionCopiaTurno)))
                        {
                            throw new Exception("Failed to create MenuImpresionCopiaTurno page");
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnAuditoriadeTurno":
                    try
                    {

                        Funciones.MsgBox("Se solicitaran las credenciales del desapachador y se lanzará el evento para imprimir el Arqueo");
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnTotalesDia":
                    try
                    {
                        ...
                        if (!this.Frame.Navigate(typeof(MenuImpresionTotalesDia)))
                        {
                            throw new Exception("Failed to create MenuImpresionTotalesDia page");
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnDatosChip":
                    try
                    {
                        ...
                        if (!this.Frame.Navigate(typeof(MenuImpresionDatosChip)))
                        {
                            throw new Exception("Failed to create MenuImpresionDatosChip page");
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnCopiaFactura":
                    try
                    {

                        if (!this.Frame.Navigate(typeof(MenuImpresionCopiaFactura)))
                        {
                            throw new Exception("Failed to create MenuImpresionCopiaFactura page");
                        }
                    }
                    catch (Exception ex)
                    {
