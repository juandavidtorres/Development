...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuOperaciones : Page
    {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnConsumos":
                    try
                    {
                        if (!Frame.Navigate(typeof(MenuConsumo)))
                        {
                            throw new Exception("Failed to create MenuConsumo page");
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnInventario":
                    try
                    {
                        if (!Frame.Navigate(typeof(MenuInventario)))
                        {
                            throw new Exception("Failed to create MenuInventario page");
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnCalibracion":
                    try
                    {
                        Funciones.MsgBox("Se llamará a la página frmCalibracion - CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
