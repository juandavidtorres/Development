...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuFidelizacion : Page
    {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnFidelizarVenta":
                    try
                    {
                        Funciones.MsgBox("Se debe llamar a la pagina MenuAcumularVenta- - CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnSaldoTarjeta":
                    try
                    {
                        Funciones.MsgBox("Se solicitará la lectura de tarjeta y se lanzará el evento de consulta de saldo- - CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnPagoconBono":
                    try
                    {
                        Funciones.MsgBox("Se consulta el metodo oArm.ValidarRedFidelizacionBono  y se llamará a las paginas frmSolicitarDatosPagoConBono o frmPagoConBono dependiendo la respuesta- CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnFidelizacionManual":
                    try
                    {
                        Funciones.MsgBox("Se solicitará la lectura de tarjeta y se llamará a la pagina frmFidelizacionManual- CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
