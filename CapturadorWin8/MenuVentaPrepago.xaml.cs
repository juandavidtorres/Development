...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuVentaPrepago : Page
    {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnVentas":
                    try
                    {
                        Funciones.MsgBox("Se llamará a la página frmPredeterminarVentaPrepago - CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnConsultaSaldo":
                    try
                    {
                        Funciones.MsgBox("Se llamará a la página frmConsultaSaldoPrepago - CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnMovimientos":
                    try
                    {
                        Funciones.MsgBox("Se llamará a la página frmConsultaMovimientosPrepago - CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnRecargaPrepago":
                    try
                    {
                        Funciones.MsgBox("Se llamará a la página frmRecargaPrepago - CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
