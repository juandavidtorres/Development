...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuTurnoAbrir : Page
    {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnAbrirTurnoenIsla":
                    try
                    {
                        //Aqui va la implementación de la funcionalidad de Apertura de turno en Isla
                        Funciones.MsgBox("Se solicitaran las credenciales del desapachador y se procede a solicitar surtidores para realizar la apertura de truno");
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnAbrirTurnodeApoyo":
                    try
                    {
                        //Aqui va la implementación de la funcionalidad de Apertura de turno de apoyo
                        Funciones.MsgBox("Se solicitaran las credenciales del desapachador y se procede a la apertura del Turno de Apoyo");
                    }
                    catch (Exception ex)
                    {
