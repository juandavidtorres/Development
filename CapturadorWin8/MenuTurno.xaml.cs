...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuTurno : Page
    {
            ...
            switch (oBoton.Name)
            {
                case "btnApertura":
                    ...
                    {                       
                        ...
                        if (!this.Frame.Navigate(typeof(MenuTurnoAbrir)))
                        {
                            throw new Exception("Failed to create MenuTurnoAbrir page");
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnCierre":
                    ...
                    {                       
                        ...
                        if (!this.Frame.Navigate(typeof(MenuTurnoCerrar)))
                        {
                            throw new Exception("Failed to create MenuTurnoCerrar page");
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnCerrarTanques":
                    try
                    {                       

                        if (!this.Frame.Navigate(typeof(MenuTurnoCerrarTanques)))
                        {
                            throw new Exception("Failed to create MenuTurnoCerrarTanques page");
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnConsignaciones":
                    try
                    {                       

                        if (!this.Frame.Navigate(typeof(MenuTurnoConsignaciones)))
                        {
                            throw new Exception("Failed to create MenuTurnoConsignaciones page");
                        }
                    }
                    catch (Exception ex)
                    {
