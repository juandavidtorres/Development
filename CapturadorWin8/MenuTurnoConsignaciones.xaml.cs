...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuTurnoConsignaciones : Page
    {

        List<Models.SobreModelo> olistaSobres = new List<Models.SobreModelo>();
        ...
        public MenuTurnoConsignaciones()
        {
        ...
        private void ListarSobres()
        {
            try
            {
                for (int i = 1; i < 10; i++)
                {
                    olistaSobres.Add(new Models.SobreModelo(1, "Sobre:" + i.ToString(), "Valor:" + (i * 1000).ToString()));
                }

                listaSobres_.ItemsSource = olistaSobres;
