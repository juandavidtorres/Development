...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuTurnoCerrar : Page
    {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnCerrarTurnoporSurtidor":
                    try
                    {

                        Funciones.MsgBox("Se solicitaran las credenciales del desapachador y se procede a solicitar surtidores para realizar el cierre por surtidor");
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnCierreTotalTurno":
                    try
                    {

                        Funciones.MsgBox("Se solicitaran las credenciales del desapachador y se procede con el cierre total del turno");
                    }
                    catch (Exception ex)
                    {
