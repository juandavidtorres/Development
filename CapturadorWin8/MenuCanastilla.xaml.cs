...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuCanastilla : Page
    {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnVentaCanastilla":
                    try
                    {
                        if (!this.Frame.Navigate(typeof(MenuCanastillaVenta)))
                        {
                            throw new Exception("Failed to create MenuCanastillaVenta page");
                        }
                    }
                    catch (Exception ex)
                    {
                    ...
                    break;
                case "btnAnularVentaCanastilla":
                    try
                    {                        
                        Funciones.MsgBox("Se deben solicitar las credenciales del desapachador");
                        if (!this.Frame.Navigate(typeof(MenuCanastillaAnularVenta)))
                        {
                            throw new Exception("Failed to create MenuCanastillaAnularVenta page");
                        }
                    }
                    catch (Exception ex)
                    {
