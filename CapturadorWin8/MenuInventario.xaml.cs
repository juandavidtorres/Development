...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuInventario : Page
    {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnCombustible":
                    try
                    {
                        if (!Frame.Navigate(typeof(MenuInventarioCombustible)))
                        {
                            throw new Exception("Failed to create MenuInventarioCombustible page");
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnCanastilla":
                    try
                    {
                        Funciones.MsgBox("Se llamará a la pagina frmRemarcacionCanastilla - CAPTURA DE DATOS");
                    }
                    catch (Exception ex)
                    {
