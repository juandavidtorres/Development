...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuImpresionCopiaVenta : Page
    {
        ...
        public MenuImpresionCopiaVenta()
        {
            ...
            switch (oBoton.Name)
            {
                case "btnUltimaVenta":
                    try
                    {
                        ...
                        if (!this.Frame.Navigate(typeof(MenuImpresionCopiaVentaUltima)))
                        {
                            throw new Exception("Failed to create MenuImpresionCopiaVentaUltima page");
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnNumerodeVenta":
                    ...
                    {                       
                        ...
                        if (!this.Frame.Navigate(typeof(MenuImpresionCopiaVentaConsecutivo)))
                        {
                            throw new Exception("Failed to create MenuImpresionCopiaVentaConsecutivo page");
                        }
                    }
                    catch (Exception ex)
                    {
