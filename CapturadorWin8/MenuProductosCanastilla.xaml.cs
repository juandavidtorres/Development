...
namespace SATELITELite
{
    ...
    /// </summary>
    public sealed partial class MenuProductosCanastilla : Page
    {
        ...
        public MenuProductosCanastilla()
        {
        ...
        private void btn_Click(object sender, RoutedEventArgs e)
        {
            ...
            switch (oBoton.Name)
            {
                case "btnCanastilla":
                    try
                    {
                        if (!this.Frame.Navigate(typeof(MenuCanastilla)))
                        {
                            throw new Exception("Failed to create MenuCanastilla page");
                        }
                    }
                    catch (Exception ex)
                    {
                ...
                case "btnRemarcacion":
                    try
                    {
                        if (!this.Frame.Navigate(typeof(MenuRemarcacionCanastilla)))
                        {
                            throw new Exception("Failed to create MenuRemarcacionCanastilla page");
                        }
                    }
                    catch (Exception ex)
                    {
